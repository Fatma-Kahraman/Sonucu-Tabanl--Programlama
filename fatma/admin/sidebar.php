  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li><a href="abouts.php"><i class="fa fa-file"></i> <span>Kurumsal Sayfalar</span></a></li>
        <li><a href="sliders.php"><i class="fa fa-image"></i> <span>Sliderlar</span></a></li>
        <li><a href="characters.php"><i class="fa fa-file"></i> <span>Karakterler</span></a></li>
