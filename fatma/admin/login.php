...
<div class="login-box">
  <div class="login-logo">
    <a href="index.php"><b>KAHRAMAN</b> YAZILIM</a>
  </div>
  <!-- /.login-logo -->
  <div class="login-box-body">
    ...
    <?php
      ...
      if (isset($_POST['admins_login'])) {
        ...
        $sonuc=$db->adminsLogin(htmlspecialchars($_POST['admins_username']),htmlspecialchars($_POST['admins_pass']),isset($_POST['remember_me']));
