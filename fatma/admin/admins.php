            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr id="item-<?php echo $row['admins_id']; ?>">
                  ...
                  ?></td>
                  <td><a href="?adminsUpdate=true&admins_id=<?php echo $row['admins_id'] ?>"><i class="fa fa-pencil"></i></a></td>
                  <td><a href="?adminsDelete=true&admins_id=<?php echo $row['admins_id'] ?>&file_delete=<?php echo $row['admins_file'] ?>"><i class="fa fa-trash"></i></a></td>
                </tr>
